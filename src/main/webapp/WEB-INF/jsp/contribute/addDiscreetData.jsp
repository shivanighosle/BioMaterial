...
<div class="container">
	...
	<div id="menubar"> <%@ include file = "./../menu_bar.jsp" %></div>
			...
			<form:form  action=""  method="post" enctype="multipart/form-data" modelAttribute="bioDiscreetDataForm" id="form1">
				...
				<div class="form-group row">
					<div class="col-sm-1">
						<form:select class="form-control" id="xVariableId1" path="xVariableId1" onclick = "getAllVariables()" onchange=" setValueInHiddenField('1')"/>
						<form:errors  class="text-danger"  path="xVariableId1" id = "xError" />					
					</div>
					<div class="col-sm-1 block">
						<form:select class="form-control" id="yVariableId" value="${bioDiscreetDataForm.yVariableId}" path="yVariableId" onclick = "getAllYVariables()"/><input type = "hidden" name = "yVariableName" id="yVariableName">
						<form:errors  class="text-danger"  path="yVariableId" />
					</div>
					<div class="col-sm-1">
